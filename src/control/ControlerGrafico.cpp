...
int WINAPI _tWinMain(HINSTANCE hInstance,HINSTANCE hPrevInstance ,TCHAR * lpCmdLine, int nCmdShow)
{
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_CONTROLERGRAFICO));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_CONTROLERGRAFICO);
